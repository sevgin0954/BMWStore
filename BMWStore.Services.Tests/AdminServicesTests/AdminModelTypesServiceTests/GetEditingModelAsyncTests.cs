...
{
    public class GetEditingModelAsyncTests : BaseAdminModelTypesServiceTest, IClassFixture<MapperFixture>
    {
        [Fact]
        ...
        public async void WithCorrectId_SgouldReturnModelWithCorrectName()
        {
            ...
            var model = await service.GetEditingModelAsync(dbModelType.Id);

            Assert.Equal(dbModelType.Name, model.Name);
        }
    }
}
